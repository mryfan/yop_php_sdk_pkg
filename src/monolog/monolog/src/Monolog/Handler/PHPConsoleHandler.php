...
use Exception;
use Fy\Monolog\Formatter\LineFormatter;
...
/**
 * Fy\Monolog handler for Google Chrome extension "PHP Console"
 *
 ...
 *
 *      $logger = new \Fy\Monolog\Logger('all', array(new \Monolog\Handler\PHPConsoleHandler()));
 *      \Fy\Monolog\ErrorHandler::register($logger);
 *      echo $undefinedVar;
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    /**
     * @param  array          $options   See \Fy\Monolog\Handler\PHPConsoleHandler::$options for more details
