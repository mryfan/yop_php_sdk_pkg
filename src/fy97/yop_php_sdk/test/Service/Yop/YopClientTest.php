...
class YopClientTest extends TestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        self::$client = YopClientBuilder::builder($appSdkConfig)->build();
    }

    /**
     * @test
     */
    public function oauth2ReportKeyTest()
    {
        $request = new Model\Oauth2ReportKeyRequest();

        $request->setKeyType("keyType_example");
        $request->setKey("key_example");
        try{
            $response = self::$client->oauth2ReportKey($request);
