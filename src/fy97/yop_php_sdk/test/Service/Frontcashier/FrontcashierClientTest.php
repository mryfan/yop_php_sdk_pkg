...
class FrontcashierClientTest extends TestCase
{
     ...
     * @test
     */
    public function bindcardConfirm_0Test()
    {
        $request = new Model\BindcardConfirm0Request();

        $request->setParentMerchantNo("parentMerchantNo_example");
        $request->setMerchantFlowId("merchantFlowId_example");
        $request->setSmsCode("smsCode_example");
        try{
            $response = self::$client->bindcardConfirm_0($request);
            print_r($response->getResult());
        }catch (\Exception $e) {
     ...
     * @test
     */
    public function bindcardRequest_0Test()
    {
        $request = new Model\BindcardRequest0Request();
        ...
        try{
            $response = self::$client->bindcardRequest_0($request);
            print_r($response->getResult());
        }catch (\Exception $e) {
