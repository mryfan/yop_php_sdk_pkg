...
class WithdrawQueryRequestMarshaller implements RequestMarshaller
{
    /**
     * @var WithdrawQueryRequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new WithdrawQueryRequestMarshaller();
    }

    /**
     * @return WithdrawQueryRequestMarshaller
     */
     ...
     * @var string
     */
    private $resourcePath = '/rest/v1.0/account/withdraw/query';
    ...
    /**
     * @param WithdrawQueryRequest $request
     * @return Request
     */
