...
/**
 * PayBatchQueryRemitOrderQueryDTOResult Class Doc Comment
 *
 * @category Class
 * @package  Fy\Yeepay\Yop\Sdk\
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PayBatchQueryRemitOrderQueryDTOResult implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PayBatchQueryRemitOrderQueryDTOResult';
     ...
     * Sets receiveAmount
     *
     * @param float $receiveAmount 收款金额
     *
     * @return $this
     */
     ...
     *
     * @param string $feeUndertakerMerchantNo 手续费承担方编号
     *
     * @return $this
     */
     ...
     * Sets failReason
     *
     * @param string $failReason 失败或冲退原因
     *
     * @return $this
     */
     ...
     * Sets receiveType
     *
     * @param string $receiveType 付款到账类型
     *
     * @return $this
     */
     ...
     *
     * @param string $receiverAccountNo 收款方账号
     *
     * @return $this
     */
     ...
     *
     * @param string $receiverBankCode 收款方银行编码
     *
     * @return $this
     */
