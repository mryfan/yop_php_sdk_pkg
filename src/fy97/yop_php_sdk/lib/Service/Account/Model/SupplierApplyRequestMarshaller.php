...
class SupplierApplyRequestMarshaller implements RequestMarshaller
{
    /**
     * @var SupplierApplyRequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new SupplierApplyRequestMarshaller();
    }

    /**
     * @return SupplierApplyRequestMarshaller
     */
     ...
     * @var string
     */
    private $resourcePath = '/rest/v1.0/account/supplier/apply';
    ...
    /**
     * @param SupplierApplyRequest $request
     * @return Request
     */
