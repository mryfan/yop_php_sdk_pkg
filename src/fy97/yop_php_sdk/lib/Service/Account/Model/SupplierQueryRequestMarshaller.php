...
class SupplierQueryRequestMarshaller implements RequestMarshaller
{
    /**
     * @var SupplierQueryRequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new SupplierQueryRequestMarshaller();
    }

    /**
     * @return SupplierQueryRequestMarshaller
     */
     ...
     * @var string
     */
    private $resourcePath = '/rest/v1.0/account/supplier/query';
    ...
    /**
     * @param SupplierQueryRequest $request
     * @return Request
     */
