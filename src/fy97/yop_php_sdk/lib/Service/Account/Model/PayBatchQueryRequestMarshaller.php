...
class PayBatchQueryRequestMarshaller implements RequestMarshaller
{
    /**
     * @var PayBatchQueryRequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new PayBatchQueryRequestMarshaller();
    }

    /**
     * @return PayBatchQueryRequestMarshaller
     */
     ...
     * @var string
     */
    private $resourcePath = '/rest/v1.0/account/pay/batch-query';
    ...
    /**
     * @param PayBatchQueryRequest $request
     * @return Request
     */
...
PayBatchQueryRequestMarshaller::__init();
